...
\author{
\textbf{Instructor:} Ali Mashtizadeh\\[1ex]
%\textbf{IAs:}
%Ryan~Hancock,
%Emil~Tsalapatis
}
...
\itms{
  \item Class web page: \url{https://cs.uwaterloo.ca/cs350/}
  \ittms{
    \item All assignments and handouts
  }
  \gap
  \item My web page: \url{https://rcs.uwaterloo.ca/~ali/}
  \ittms{
    \item Lecture notes
  }
  \gap
...
\itms{
  ...
  \gap
  \item Quizzes and Final through Waterloo LEARN
  \gap
...
\itms{
  ...
  \ittms{
    \item Every computer, phone and watch runs an OS
...
\itms{
  ...
  \ittms{
    \item Most OSes heavily influenced by Unix (e.g. OS161)
